...
INSERT IGNORE INTO `client` (`id`, `user_id`, `national_id`, `image`, `title`, `description`, `type`, `time_created`, `is_active`) VALUES
(2, 11, '/uploads/national_idt.webp', '/uploads/ClientImageTueMar2220227:05amazon.png', 'Nakuru Mattress LTD', 'A homegrown supermarket established in 2006 with our first branch in Nakuru town. We&#039;ve later grown and so far have a total of 46 branches in 12 counties across Kenya.\r\n\r\nWe pride ourselves with delivering an exceptional customer experience every time while providing our shopper with variety of goods at an affordable price!\r\n\r\nVisit any of our branches today and enjoy delectable pastries from our Bakery, sumptuous meals at our Deli, fresh cuts at the Butchery and so much more!\r\n\r\nUnique Value Proposition:\r\n\r\nFresh &amp; Easy. Price Guarantee!', 'company', '2022-03-22 07:05:12', 1),
...
INSERT IGNORE INTO `freelancer` (`id`, `user_id`, `national_id`, `title`, `description`, `years_of_experience`, `time_created`, `is_active`) VALUES
...
INSERT IGNORE INTO `freelancer_skill` (`id`, `freelancer_id`, `skill_id`) VALUES
(40, 10, 1),
(41, 10, 2),
(38, 10, 4),
(39, 10, 5),
...
INSERT IGNORE INTO `job` (`id`, `client_id`, `title`, `description`, `image`, `pay_rate_per_hour`, `expected_duration_in_hours`, `receive_job_proposals_deadline`, `time_created`, `is_active`) VALUES
...
INSERT IGNORE INTO `job_payment` (`id`, `job_id`, `phone_number`, `amount`, `is_payment_successful`, `response_merchant_request_id`, `response_checkout_request_id`, `response_response_code`, `callback_result_code`, `callback_result_desc`) VALUES
...
INSERT IGNORE INTO `job_payment_dispatch` (`id`, `job_payment_id`, `is_refund`, `phone_number`, `amount`, `is_dispatch_successful`, `response_conversation_id`, `response_originator_conversation_id`, `response_response_code`) VALUES
...
INSERT IGNORE INTO `job_proposal` (`id`, `status`, `title`, `description`, `job_id`, `freelancer_id`, `submission_description`, `submission_attachment`, `client_comment`, `time_work_starts`, `time_work_ends`, `24_hr_expiry_email_sent`, `time_created`, `is_active`) VALUES
...
INSERT IGNORE INTO `job_rating` (`id`, `job_id`, `type`, `rating`, `comment`) VALUES
...
INSERT IGNORE INTO `job_skill` (`id`, `job_id`, `skill_id`) VALUES
(7, 5, 8),
(19, 5, 15),
(8, 6, 1),
(10, 6, 2),
...
INSERT IGNORE INTO `log` (`id`, `user_id`, `type`, `action`, `ip_address`, `time_created`) VALUES
...
INSERT IGNORE INTO `user` (`id`, `email`, `phone`, `password`, `first_name`, `middle_name`, `last_name`, `image`, `country`, `county`, `city`, `is_admin`, `is_active`, `time_created`) VALUES
